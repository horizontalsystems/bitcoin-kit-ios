...
extension DataProvider: IDataProvider {
    ...
    var debugInfo: String {
        ...
        for pubKey in pubKeys {
            ...
            lines.append("\(pubKey.index) --- \(pubKey.external) --- \(pubKey.keyHash.hex) --- \(addressConverter.convertToLegacy(keyHash: pubKey.keyHash, version: network.pubKeyHash, addressType: .pubKeyHash).stringValue) --- \(bechAddress)")
        }
