...
//        mockPeerHostManager = mockBitcoinKit.mockPeerHostManager
//        mockFactory = mockBitcoinKit.mockFactory
//        peers = [
//            "0.0.0.0": MockPeer(host: "0.0.0.0", network: mockBitcoinKit.mockNetwork),
//            "0.0.0.1": MockPeer(host: "0.0.0.1", network: mockBitcoinKit.mockNetwork),
//            "0.0.0.2": MockPeer(host: "0.0.0.2", network: mockBitcoinKit.mockNetwork),
//            "0.0.0.3": MockPeer(host: "0.0.0.3", network: mockBitcoinKit.mockNetwork)
//        ]
...
//
//        peerGroup = PeerGroup(
//                factory: mockBitcoinKit.mockFactory, network: mockBitcoinKit.mockNetwork, peerHostManager: mockBitcoinKit.mockPeerHostManager, bloomFilters: [Data](), peerCount: 3,
